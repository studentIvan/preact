!function() {
    ...
    function flushMounts() {
        ...
        while (c = mounts.pop()) {
            ...
            if (c.componentDidMount) try {
                c.componentDidMount();
            } catch (e) {
                catchErrorInComponent(e, c.__a);
            }
        }
    }
    ...
    function idiff(dom, vnode, context, mountAll, componentRoot) {
        ...
        if ('function' == typeof vnodeName) return buildComponentFromVNode(dom, vnode, context, mountAll, componentRoot);
        ...
        } else if (vchildren && vchildren.length || null != fc) innerDiffNode(out, vchildren, context, mountAll, hydrating || null != props.dangerouslySetInnerHTML, componentRoot);
    ...
    function catchErrorInComponent(error, component) {
        flushMounts();
        for (;component; component = component.__a) if (component.componentDidCatch && !component.__e) try {
    ...
    function renderComponent(component, renderMode, mountAll, isChild) {
        if (!component.__x) {
            var rendered, inst, cbase, exception, props = component.props, state = component.state, context = component.context, previousProps = component.__p || props, previousState = component.__s || state, previousContext = component.__c || context, isUpdate = component.base, nextBase = component.__b, initialBase = isUpdate || nextBase, initialChildComponent = component._component, skip = !1, snapshot = previousContext, clearCaught = component.__e;
            try {
                ...
                if (!skip) {
                    ...
                    try {
                        ...
                        exception = e;
                        clearCaught = !1;
                        if (!base) base = initialBase || document.createTextNode("");
                    }
                    ...
                    if (toUnmount && toUnmount.base) unmountComponent(toUnmount);
                    component.base = base;
                    if (base && !isChild) {
                ...
                if (clearCaught) component.__e = !1;
            } catch (e) {
                catchErrorInComponent(e, component.__a);
            }
            if (void 0 !== exception) catchErrorInComponent(exception, component);
            if (!diffLevel && !isChild) flushMounts();
        }
    }
    function buildComponentFromVNode(dom, vnode, context, mountAll, ancestorComponent) {
    ...
    function unmountComponent(component) {
        if (!component.__x) {
            ...
            if (component.componentWillUnmount) try {
